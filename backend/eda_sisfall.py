...
Genera:
  ...
  - Detector automático de posibles fugas: para cada feature numérica,
    ...
    entrenar nada.
  - Boxplots de cada feature por clase (fall_event) -> eda_output/boxplots/
  - Matriz de correlación entre features -> eda_output/correlation_heatmap.png
  - Conteo de ensayos por sujeto -> eda_output/trials_per_subject.png
